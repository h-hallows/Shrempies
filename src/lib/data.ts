...
export const songs = [
  ...
  { title: "Claws & Antennae", category: "Character Intros", hook: "Ensemble character roll-call", lyric: "Claws and antennae, tails and big bright eyes,\nShrempy and the crew under ocean skies.\nWobble and Snip and Dozy and Dot,\nBlippy and Rufus — we love them a lot!" },
  { title: "My Best Friend Shrempy", category: "Character Intros", hook: "From the child's POV — Shrempy as their companion", lyric: "My best friend Shrempy lives under the sea,\nbut every time I visit Shrempy's there for me.\nWe explore together, we feel things too —\nmy best friend Shrempy, and best friend's you." },
  // Volume 2
...
export const episodes = [
  { number: 1, title: "The Shell That Wasn't There", lesson: "Persistence, problem-solving", description: "Shrempy searches the whole reef for a special shell — and learns that looking is as important as finding.", characters: ["Shrempy", "Snip"] },
  { number: 2, title: "Rufus Speaks", lesson: "Every voice matters, waiting is worth it", description: "The crew learns to slow down and listen when Rufus has something very important to say.", characters: ["Rufus", "Shrempy", "Wobble"] },
  { number: 3, title: "Blippy's Big Bubble", lesson: "Unique traits are gifts", description: "Blippy's bubbles cause trouble — until one saves the day in the most unexpected way.", characters: ["Blippy", "Shrempy"] },
  { number: 4, title: "Too Many Bubbles", lesson: "Overstimulation, finding quiet", description: "The ocean gets very loud and very bright. Shrempy and Dozy find a quiet spot together.", characters: ["Shrempy", "Dozy"] },
  { number: 5, title: "Dot's Perfect Morning", lesson: "Routine, and what happens when it changes", description: "Dot's morning routine is disrupted. Everything feels wrong — until something unexpectedly wonderful happens.", characters: ["Dot", "Snip"] },
  { number: 6, title: "The Dark Part of the Reef", lesson: "Facing fear with a friend", description: "Something is in the dark part of the reef. Shrempy is scared — but not alone.", characters: ["Shrempy", "Snip", "Rufus"] },
  { number: 7, title: "Shrempy Tries and Tries", lesson: "Failure as learning", description: "Shrempy tries to do something very hard. Again and again and again.", characters: ["Shrempy", "Wobble"] },
  { number: 8, title: "The New Shrempy", lesson: "New friendships, belonging", description: "A new face appears at the reef. Nobody knows quite what to do — except Dot, who knows exactly how it feels to be new.", characters: ["Dot", "Shrempy", "Wobble Jr."] },
  { number: 9, title: "Wobble's Big Dance", lesson: "Trying something new, being seen", description: "Wobble wants to dance on the Big Stage. It's thrilling. It's terrifying. It's both.", characters: ["Wobble", "Wobble Jr.", "Shrempy"] },
  { number: 10, title: "What's On the Other Side?", lesson: "Curiosity, exploring the unknown", description: "Beyond the reef is a place no Shrempy has ever gone. Shrempy is going.", characters: ["Shrempy", "Blippy"] },
  { number: 11, title: "Dozy's Important Dream", lesson: "Rest matters, inner voice", description: "Dozy keeps falling asleep. The crew wonders why. The answer is in the dream.", characters: ["Dozy", "Shrempy"] },
  { number: 12, title: "The Colour Nobody Knew", lesson: "Discovery, there's always more", description: "A colour appears that nobody has a name for. Who gets to name it?", characters: ["Blippy", "Dot", "Shrempy"] },
  { number: 13, title: "Snip Needs Help", lesson: "Asking for help is brave", description: "Snip is the one everyone leans on. But today Snip needs help — and doesn't know how to ask.", characters: ["Snip", "Shrempy", "Rufus"] },
  { number: 14, title: "Shrempy's Goodbye", lesson: "Transitions, endings are okay", description: "Something is changing. Shrempy isn't sure how to feel about it. Goodbye and hello live side by side.", characters: ["Shrempy", "Snip", "Wobble", "Dot"] },
  { number: 15, title: "The Biggest Storm", lesson: "Fear, safety, being held", description: "The storm is very big. The reef shakes. The whole crew holds together.", characters: ["Shrempy", "Rufus", "Dozy", "Blippy", "Wobble"] },
  { number: 16, title: "Home", lesson: "Where you belong", description: "After a long adventure, Shrempy finds the way back. Home was never lost.", characters: ["Shrempy", "Snip", "Wobble", "Dot", "Rufus", "Blippy", "Dozy", "Wobble Jr."] },
];
