...
export const episodes = [
  ...
  { number: 8, title: "The New Shrempy", lesson: "New friendships, belonging", description: "A new face appears at the reef. Nobody knows quite what to do — except Dot, who knows exactly how it feels to be new.", characters: ["Dot", "Pip", "Sandy"] },
